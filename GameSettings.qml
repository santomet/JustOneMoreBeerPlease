...
Item {
    ...
    readonly property color delegateActiveColor: "#1F5D31"
    readonly property color delegateActive1Color: Qt.darker(delegateActiveColor, 1.2)
    readonly property color delegateActive2Color: Qt.lighter(delegateActiveColor, 1.2)
    ...
    property real fieldMargin: fieldHeight * 0.1
