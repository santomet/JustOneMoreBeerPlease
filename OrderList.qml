...
//        }
        ...
        Text {
            ...
            text: backend.activeTable.length == 0 ? "SELECT TABLE FIRST!" : "ORDERS FOR " + backend.activeTable;
        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                MouseArea {
                    ...
                    anchors.bottom: parent.bottom
                    onClicked: {
                        if(modelData.orderCount > modelData.fulfilled) {
                            modelData.fulfilled++
                            fulfillmentCost += modelData.price
                        }
...
//                            totalCost -= modelData.price
                ...
                Text {
                    id: orderc
                    font.pixelSize: GameSettings.smallFontSize
                    text: modelData.fulfilled + "/" + modelData.orderCount
                    anchors.bottom: parent.bottom
...
//    }
    ...
    Text {
        ...
        color: GameSettings.textColor
        font.pixelSize: GameSettings.smallFontSize
        text: qsTr("Total: ") + fulfillmentCost + "/" + backend.costActiveTable + " CZK"
    }
